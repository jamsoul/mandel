...
REGISTER_LEGACY_CF_HOST_FUNCTION( alt_bn128_add );
REGISTER_LEGACY_CF_HOST_FUNCTION( alt_bn128_mul );
REGISTER_LEGACY_CF_HOST_FUNCTION( alt_bn128_pair );
REGISTER_LEGACY_CF_HOST_FUNCTION( mod_exp );
